...
-- Inserindo Dados em Suas Devidas Tabelas

select * from funcionarios;

insert into funcionarios (nome_completo, cpf, data_nascimento, endereco, telefone, email, cargo, salario, data_admissão) values
...
insert into clientes (nome_completo, cpf, data_nascimento, endereco, telefone, email, data_cadastro) values
